 ...
 */
public interface WeiBoWebsiteService {
	 ...
	 * 拦截处理此异常
	 */
	WeiBoWebsiteProperties.WeiBoWebsite getWeiBoWebsiteByAppid(String appid) throws OAuth2AuthenticationException;
	...
	OAuth2AccessTokenResponse getOAuth2AccessTokenResponse(HttpServletRequest request, HttpServletResponse response,
			String tokenUrlPrefix, String tokenUrl, String appid, String redirectUriPrefix,
			@NonNull Map<String, String> uriVariables) throws OAuth2AuthenticationException;
	 ...
	 * 拦截处理此异常
	 */
	WeiBoWebsiteTokenResponse getAccessTokenResponse(String appid, String code, String state, String binding,
